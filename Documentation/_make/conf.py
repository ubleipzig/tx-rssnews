# -*- coding: utf-8 -*-
#
# RSS News Feed documentation build configuration file, created by
# TYPO3 extension sphinx on Wed, 13 Apr 2016 13:42:42 +0530.
#
...
project = u'RSS News Feed'
copyright = u'2016, Arun Chandran'
...
htmlhelp_basename = 'pits_rssnewsdoc'
...
latex_documents = [
    ('Index', 'pits_rssnews.tex', u'RSS News Feed',
     u'Arun Chandran', 'manual'),
]
...
pdf_documents = [
    ('Index', 'pits_rssnews', u'RSS News Feed',
     u'Arun Chandran'),
]
...
texinfo_documents = [
    ('Index', 'pits_rssnews', u'RSS News Feed',
     u'Arun Chandran', 'RSS News Feed', 'One line description of project.',
     'Miscellaneous'),
]
